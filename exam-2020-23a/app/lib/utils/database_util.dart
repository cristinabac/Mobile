...
class DatabaseHelper {
  ...
  String dbName = 'items52.db';


  void _createDb(Database db, int newVersion) async {
    await db.execute('CREATE TABLE $itemsTable($colIdLocal INTEGER PRIMARY KEY AUTOINCREMENT, $colId INTEGER, $colTable TEXT, '
        '$colDetails TEXT, $colStatus TEXT, $colTime INTEGER, $colType TEXT);');
    print("DONE");
    await db.execute('CREATE TABLE $itemsTableOffline($colIdLocal INTEGER PRIMARY KEY AUTOINCREMENT, $colId INTEGER DEFAULT 0, $colTable TEXT, '
        '$colDetails TEXT, $colStatus TEXT, $colTime INTEGER, $colType TEXT)');
  }
