...
class DatabaseHelper {
  ...
  String dbName = 'ab3.db';


  void _createDb(Database db, int newVersion) async {
    await db.execute('CREATE TABLE $itemsTable($colIdLocal INTEGER PRIMARY KEY AUTOINCREMENT);');
    print("DONE FMM");
    await db.execute('CREATE TABLE $itemsTableOffline($colIdLocal INTEGER PRIMARY KEY AUTOINCREMENT)');
  }
