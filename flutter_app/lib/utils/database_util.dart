...
class DatabaseHelper {
  ...
  String colId = 'id';
  String colName = 'name';
  String colGroup = '"group"';
  String colDetails = 'details';
  String colStatus = 'status';
  String colStudents = 'students';
  String colType = 'type';


  String itemsTableOffline = 'items_table2';

  String dbName = 'db7.db';


  void _createDb(Database db, int newVersion) async {
    await db.execute('CREATE TABLE $itemsTable($colIdLocal INTEGER PRIMARY KEY AUTOINCREMENT, $colId INTEGER, '
        '$colName TEXT, '
        '$colGroup TEXT, '
        '$colDetails TEXT, '
        '$colStatus TEXT, '
        '$colStudents INTEGER, '
        '$colType TEXT);');
    await db.execute('CREATE TABLE $itemsTableOffline($colIdLocal INTEGER PRIMARY KEY AUTOINCREMENT, $colId INTEGER, '
        '$colName TEXT, '
        '$colGroup TEXT, '
        '$colDetails TEXT, '
        '$colStatus TEXT, '
